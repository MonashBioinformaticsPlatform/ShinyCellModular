...
| :---:|  :----: | :----: |
| ![[Launch App](man/figures/launchapp_blue.svg)]("https://bioinformatics.erc.monash.edu/shinyapps-public/app/scrnaseq-shinycellmodular-example") | ![[Documentation](man/figures/documentation.svg)](https://monashbioinformaticsplatform.github.io/ShinyCellModular/) | ![[Developers Guide](man/figures/dev_guide.svg)](vignettes/developer_guide.md) |
...
### 2. [`prepShinyCellModular()`](vignettes/prepShinyCellModular_explained.md)
...
### 3. [`useShinyCellModular()`](vignettes/useShinyCellModular_explained.md)
