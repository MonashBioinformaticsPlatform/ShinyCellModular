...
datasets <- list(
  ...
  list(
    ...
    n_cells     = "5000",
    n_clusters  = 14L,
    extra_meta  = c("genes" = "35,635"),
    app_url     = "https://bioinformatics3.erc.monash.edu/rsconnect/content/547/",       # TODO: replace URL
    rmd_url     = "https://bioinformatics.erc.monash.edu/home/lper0012/ShinyCellModular_How-to-guide_RMDs/ShinyCellModular_ScRNAseq.html",        # TODO: replace URL
    updated     = "2 weeks ago"
  )#,
